...
describe("Quantitative Analysis Engine", () => {
    ...
    describe("Complete Execution", () => {
        ...
        it("should return a CSV output", () => {
            ...
            expect(dataAccessResult).toBe('DATABASE SERVER RESOURCE;DATA ACCESS;0,0278;0,2000;0,2011;0,0056');
            expect(viewDamageReport).toBe('VIEW COMPONENT RESOURCE;VIEW DAMAGE REPORT;0,0313;2,0000;2,1333;0,0625');
            expect(databaseEntry).toBe('DATABASE SYSTEM RESOURCE;DATABASE ENTRY;0,0069;0,5000;0,5070;0,0139');
        });
    });
});